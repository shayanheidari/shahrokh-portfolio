  ...
  return (
    <>
      <div
        ...
        id="background"
      >
        <div className="md:flex md:justify-center  md:w-[50vw] md:h-[60vh]">
          <div className="mx-10 mt-12 flex flex-col md:grid md:grid-cols-2 md:grid-rows-2 md:content-center md:justify-items-center justify-center items-center gap-4 ">
            <div className="card_ h-[28vh] pb-4">
              ...
              <p className="text-pretty text-text text-[1.1rem] h-55 md:h-auto overflow-y-scroll">
                ...
                Ph.D. in Computer Science, The University of Auckland
                <br />
                Thesis:{" "}
                ...
                M.Sc. in Software Engineering, Science and Research Branch, Azad
                University
              </p>
            </div>
            <div className="card_ h-[20vh]">
              ...
              <p className="text-pretty text-text text-[1.1rem] h-45 md:h-auto overflow-y-scroll">
                ...
                Postdoctoral Fellow in Computer Science, The University of
                Auckland <br /> Research Focus: AI model improvement strategies
                for biosecurity computer vision applications.
              </p>
            </div>
            <div className="card_ h-[33vh] md:col-span-2">
              ...
              <p className="text-pretty text-text text-[1.1rem] h-66 md:h-auto overflow-y-scroll w-full">
                ...
                Research Fellow, Institute of Marine Science, The University of
                Auckland
